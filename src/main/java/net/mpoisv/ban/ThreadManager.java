            ...
            TimerTask task = new TimerTask() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Bukkit.getConsoleSender().sendMessage("§bː§f UUID §bː §r" + LanguageManager.DBWorkFailed.replace("%error-message%", e.getLocalizedMessage()).replace("%error-cause%", e.getCause().toString()));
                    }
